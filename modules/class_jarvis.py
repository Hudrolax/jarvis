...
class Jarvis:
    ...
    def __init__(self):
        ...
        self.satellite_server.add_miner('zeon', instant_off_by_poweroff=True, shutdown_threshold=(180, 190), shutdown_no_ac_sec=600)
        self.satellite_server.add_miner('serverx', instant_off_by_poweroff=True, shutdown_threshold=(180, 190), shutdown_no_ac_sec=600)
