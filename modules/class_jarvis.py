...
class Jarvis:
    ...
    def __init__(self):
        ...
        self.satellite_server.add_miner('zeon', instant_off_by_poweroff=True, shutdown_threshold=(180, 190))
        self.satellite_server.add_miner('serverx', instant_off_by_poweroff=True, shutdown_threshold=(180, 190))
        self.satellite_server.add_miner('tekilla', instant_off_by_poweroff=True, shutdown_threshold=(180, 190))
        self.satellite_server.add_miner('LK_rig1', instant_off_by_poweroff=False, shutdown_threshold=(180, 190))
        self.satellite_server.add_miner('LK_rig2', instant_off_by_poweroff=False, shutdown_threshold=(180, 190))
        self.satellite_server.add_miner('LK_rig4', instant_off_by_poweroff=False, shutdown_threshold=(180, 190))
        self.satellite_server.add_miner('LK_rig10', instant_off_by_poweroff=False, shutdown_threshold=(160, 180))
